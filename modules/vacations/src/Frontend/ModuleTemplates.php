<?php
/**
 * Localizador de templates del módulo Vacaciones.
 *
 * Override desde el tema: wp-content/themes/<tema>/welow-rrhh/vacations/<relative>.php
 *
...
final class ModuleTemplates {
	...
	public static function locate( string $relative ): ?string {
		...
		$theme = trailingslashit( get_stylesheet_directory() ) . 'welow-rrhh/vacations/' . $relative;
		if ( is_readable( $theme ) ) {
			return $theme;
		}
		$plugin = WELOW_RRHH_PLUGIN_DIR . 'modules/vacations/templates/' . $relative;
